...
def parse_options():
    ...
    parser.add_argument('--bForgiving', dest='bForgiving',
                        ...
                        default=False)
    # os.chdir('/home/gxf1212/data/work/make_hybrid_top/openforcefield-protein-ligand-benchmark/hif2a/FEP/prod1/38-8/try-pmx')
    # args = parser.parse_args('-itp 38.itp -ff /home/gxf1212/data/work/make_hybrid_top/charmm36.ff -prm 38.prm --priority prm -o 38_full.itp'.split())
