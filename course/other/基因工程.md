...
* template chain
    ...
    * Gene specific primer
        * No need to remove RNA
        * Add poly C and oligo-dT as primer
* remove RNA
    * RNase H
* coding chain
...
###### Construction
* Digestion into fragments, insert into cosmid, package into phases
###### Screening
* Same
#### Insertion
into lambda
...
#### Reverse PCR
##### Reversed primer
##### Explore outside the known sequence 
(eg:chromosome)
...
###### See chp 4
##### SLIC
###### T4 polymerase generates 5’ overhang on linearized vector and insert, then transform
###### No RE/ligase
##### Gibbson assembly
###### Steps
* T5 exonuclease chew back 5’ (3’ overhang)
* 15~20 overlap seq pairs, cannot chew
...
###### Maybe lyse bacteria in situ
###### Maybe extract and CoIP
# genetic engineering
...
##### Distance between promoter
and initiator codon gene ATG
###### Lower if farther, generally
##### Distance between SD seq
and initiator codon AUG
###### Similar
#### RNA processing
##### 2nd structure
###### Affects SD seq shape—recognition
##### Transcription terminator
###### Prevent unnecessary transcription
read-through and unexpected 2nd struc
#### RNA stability
#### Translation
##### Copy number
...
##### LacZ residues does not matter activity;
or cleave them
#### Induced
##### IPTG
...
#### Genetic analysis, 四个diploid孢子可分离
### Types of vector
...
##### have to integrate into genome, under selection pressure
#### Selection
##### Transformation efficiency, copy number:
YEp>YRp>YCp>YIp
##### Stability: C,I>E,R
...
###### 2 types of integration: marker and YFP
...
###### Gal4: BD (bait), fused with your interest
AD (prey) fused with a library
##### Operation
...
###### Find interacting protein
#### HBV vaccine
##### Subunit vaccine, HB core Ag
##### Transform DNA to produce HBcAg
#### Natural product
...
* Vector
    * aph gene inserts and interrupts
the gene to be knock-out
...
#### Sheep
##### Bioreactor (microinjection)
produce proteins in the milk
